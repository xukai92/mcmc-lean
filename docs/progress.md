...
| Fixed-parameter production-shaped NUTS | Runtime semantics only | Not yet proved for the runtime transition | — | Classic/generalized termination × multinomial/slice selection, fixed metrics, depth/divergence diagnostics | Online early-exit continuation agrees with completed-tree checking; numerical construction and candidate-selection correspondence remain |
