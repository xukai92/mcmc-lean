...
| Fixed-parameter production-shaped NUTS | Runtime semantics only | Not yet proved for the runtime transition | — | Classic/generalized termination × multinomial/slice selection, fixed metrics, depth/divergence diagnostics | Successful online/completed builds have equal ordered candidates, and certified numeric decisions refine the full online summary; concrete recursion-trace and transition correspondence remain |
