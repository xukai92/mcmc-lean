...
| Fixed-parameter production-shaped NUTS | Runtime semantics only | Not yet proved for the runtime transition | — | Classic/generalized × multinomial/slice × ordinary/jittered/tempered, all fixed metrics, depth/divergence diagnostics | Certified decisions refine online candidates; balanced index recursion including leaf failures equals structural continuation; Julia call-trace and full-transition correspondence remain |
