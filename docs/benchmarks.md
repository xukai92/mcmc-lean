...
The `completed-tree` group gives all three implementations the same fixed `2^d` leapfrog budget. Its `verified-reference` row uses the completed-tree C.4 rerooting construction proved in Lean; the Optimized and AdvancedHMC rows use their fixed-length multinomial implementations and are work-matched rather than transition-equivalent. The separate `dynamic-nuts` group compares Optimized against AdvancedHMC under the same maximum depth and generalized U-turn termination.
...
| Isotropic Gaussian | completed-tree | verified-reference | 5169.7 ms | 5040.5–5263.6 ms | 1934 | 16.0 | n/a |
| Isotropic Gaussian | completed-tree | verified-optimized | 495.7 ms | 493.4–498.1 ms | 20174 | 16.0 | n/a |
| Isotropic Gaussian | completed-tree | advancedhmc | 842.2 ms | 835.7–851.8 ms | 11874 | 16.0 | n/a |
| Isotropic Gaussian | dynamic-nuts | verified-optimized | 536.4 ms | 531.0–540.3 ms | 18643 | 15.0 | n/a |
| Isotropic Gaussian | dynamic-nuts | advancedhmc | 831.3 ms | 827.6–844.4 ms | 12029 | 15.0 | n/a |
...
| Correlated Gaussian (ρ=0.9) | completed-tree | verified-reference | 5958.5 ms | 5851.9–6022.6 ms | 1678 | 16.0 | n/a |
| Correlated Gaussian (ρ=0.9) | completed-tree | verified-optimized | 760.3 ms | 755.2–762.3 ms | 13153 | 16.0 | n/a |
| Correlated Gaussian (ρ=0.9) | completed-tree | advancedhmc | 942.4 ms | 937.4–946.9 ms | 10612 | 16.0 | n/a |
| Correlated Gaussian (ρ=0.9) | dynamic-nuts | verified-optimized | 712.1 ms | 709.5–720.3 ms | 14042 | 15.0 | n/a |
| Correlated Gaussian (ρ=0.9) | dynamic-nuts | advancedhmc | 963.5 ms | 956.7–968.8 ms | 10379 | 15.0 | n/a |
...
| Product quartic | completed-tree | verified-reference | 6570.2 ms | 6456.0–6588.5 ms | 1522 | 16.0 | n/a |
| Product quartic | completed-tree | verified-optimized | 827.0 ms | 824.0–835.3 ms | 12092 | 16.0 | n/a |
| Product quartic | completed-tree | advancedhmc | 1023.4 ms | 1011.2–1030.7 ms | 9772 | 16.0 | n/a |
| Product quartic | dynamic-nuts | verified-optimized | 779.8 ms | 771.9–781.3 ms | 12825 | 15.0 | n/a |
| Product quartic | dynamic-nuts | advancedhmc | 1048.1 ms | 1026.4–1057.9 ms | 9541 | 15.0 | n/a |
...
| Ill-conditioned Gaussian | completed-tree | verified-reference | 6824.6 ms | 6717.6–6840.5 ms | 1465 | 16.0 | n/a |
| Ill-conditioned Gaussian | completed-tree | verified-optimized | 729.8 ms | 725.0–732.9 ms | 13703 | 16.0 | n/a |
| Ill-conditioned Gaussian | completed-tree | advancedhmc | 947.3 ms | 942.2–955.1 ms | 10557 | 16.0 | n/a |
| Ill-conditioned Gaussian | dynamic-nuts | verified-optimized | 684.9 ms | 680.9–689.4 ms | 14602 | 15.0 | n/a |
| Ill-conditioned Gaussian | dynamic-nuts | advancedhmc | 984.7 ms | 977.6–992.6 ms | 10156 | 15.0 | n/a |
...
| Regularized logistic | completed-tree | verified-reference | 7507.1 ms | 7445.6–7577.6 ms | 1332 | 16.0 | n/a |
| Regularized logistic | completed-tree | verified-optimized | 1244.1 ms | 1239.5–1250.5 ms | 8038 | 16.0 | n/a |
| Regularized logistic | completed-tree | advancedhmc | 1282.5 ms | 1273.9–1301.7 ms | 7798 | 16.0 | n/a |
| Regularized logistic | dynamic-nuts | verified-optimized | 1079.8 ms | 1070.7–1091.4 ms | 9261 | 15.0 | n/a |
| Regularized logistic | dynamic-nuts | advancedhmc | 1278.4 ms | 1264.2–1294.8 ms | 7823 | 15.0 | n/a |
...
| Isotropic Gaussian | completed-tree | verified-reference | 1.001 | 5919.4 | 11556.4 | 0.0018 | 0.0131 | 0.0393 | 0.0381 | 112.6 | 0.012 | 0.014 | 0.995 | — | 0 | 16.0 |
| Isotropic Gaussian | completed-tree | verified-optimized | 1.001 | 6778.3 | 12772.2 | 0.0021 | 0.0124 | 0.0343 | 0.0360 | 1339.9 | 0.011 | 0.013 | 0.996 | — | 0 | 16.0 |
| Isotropic Gaussian | completed-tree | advancedhmc | 1.002 | 6659.4 | 13630.9 | 0.0042 | 0.0121 | 0.0411 | 0.0338 | 812.2 | 0.011 | 0.014 | 0.941 | 0.997 | 0 | 16.0 |
| Isotropic Gaussian | dynamic-nuts | verified-optimized | 1.001 | 10480.3 | 22574.3 | 0.0035 | 0.0098 | 0.0256 | 0.0225 | 1928.8 | 0.009 | 0.008 | 1.000 | 0.997 | 0 | 15.0 |
| Isotropic Gaussian | dynamic-nuts | advancedhmc | 1.001 | 10631.5 | 21690.6 | 0.0071 | 0.0098 | 0.0285 | 0.0223 | 1302.0 | 0.009 | 0.010 | 1.000 | 0.997 | 0 | 15.0 |
...
| Correlated Gaussian (ρ=0.9) | completed-tree | verified-reference | ⚠ 1.013 | 1003.0 | 3757.9 | 0.0003 | 0.0257 | 0.0842 | 0.0930 | 14.4 | 0.040 | 0.032 | 0.932 | — | 0 | 16.0 |
| Correlated Gaussian (ρ=0.9) | completed-tree | verified-optimized | 1.008 | 1152.1 | 4200.8 | 0.0004 | 0.0253 | 0.0849 | 0.0457 | 125.8 | 0.022 | 0.035 | 0.996 | — | 0 | 16.0 |
| Correlated Gaussian (ρ=0.9) | completed-tree | advancedhmc | ⚠ 1.015 | 1187.6 | 3994.8 | 0.0007 | 0.0247 | 0.0760 | 0.0755 | 99.3 | 0.039 | 0.033 | 0.940 | 0.952 | 0 | 16.0 |
| Correlated Gaussian (ρ=0.9) | dynamic-nuts | verified-optimized | 1.005 | 1410.2 | 5758.8 | 0.0005 | 0.0225 | 0.0541 | 0.0590 | 169.7 | 0.023 | 0.024 | 1.000 | 0.949 | 0 | 15.0 |
| Correlated Gaussian (ρ=0.9) | dynamic-nuts | advancedhmc | 1.003 | 1567.8 | 5410.3 | 0.0010 | 0.0227 | 0.0616 | 0.0540 | 142.8 | 0.023 | 0.029 | 1.000 | 0.949 | 0 | 15.0 |
...
| Product quartic | completed-tree | verified-reference | 1.001 | 12222.1 | 28538.8 | 0.0038 | 0.0063 | — | 0.0232 | 192.2 | 0.008 | 0.008 | 0.995 | — | 0 | 16.0 |
| Product quartic | completed-tree | verified-optimized | 1.001 | 13995.7 | 31449.0 | 0.0044 | 0.0060 | — | 0.0199 | 1716.1 | 0.008 | 0.007 | 0.996 | — | 0 | 16.0 |
| Product quartic | completed-tree | advancedhmc | 1.001 | 14335.6 | 32305.9 | 0.0090 | 0.0060 | — | 0.0193 | 1381.8 | 0.008 | 0.007 | 0.941 | 0.989 | 0 | 16.0 |
| Product quartic | dynamic-nuts | verified-optimized | 1.000 | 24134.2 | 54279.9 | 0.0080 | 0.0046 | — | 0.0138 | 2981.0 | 0.006 | 0.005 | 1.000 | 0.988 | 0 | 15.0 |
| Product quartic | dynamic-nuts | advancedhmc | 1.000 | 24640.2 | 54886.3 | 0.0164 | 0.0046 | — | 0.0123 | 2319.2 | 0.006 | 0.005 | 1.000 | 0.988 | 0 | 15.0 |
...
| Ill-conditioned Gaussian | completed-tree | verified-reference | 1.000 | 87055.4 | 54706.2 | 0.0272 | 0.3021 | 13.3298 | 1.2211 | 1304.0 | 0.035 | 0.038 | 0.995 | — | 0 | 16.0 |
| Ill-conditioned Gaussian | completed-tree | verified-optimized | 1.000 | 82995.2 | 55863.3 | 0.0259 | 0.3065 | 12.3651 | 1.2725 | 11736.3 | 0.035 | 0.036 | 0.996 | — | 0 | 16.0 |
| Ill-conditioned Gaussian | completed-tree | advancedhmc | 1.000 | 86291.9 | 56109.0 | 0.0539 | 0.2859 | 13.3656 | 1.7168 | 9267.7 | 0.037 | 0.040 | 0.939 | 0.893 | 0 | 16.0 |
| Ill-conditioned Gaussian | dynamic-nuts | verified-optimized | 1.000 | 86734.3 | 54470.5 | 0.0289 | 0.2915 | 18.1091 | 1.7082 | 13146.4 | 0.032 | 0.038 | 1.000 | 0.886 | 0 | 15.0 |
| Ill-conditioned Gaussian | dynamic-nuts | advancedhmc | 1.000 | 86979.1 | 55881.0 | 0.0580 | 0.3187 | 14.4449 | 1.0218 | 9135.6 | 0.031 | 0.035 | 1.000 | 0.885 | 0 | 15.0 |
...
| Regularized logistic | completed-tree | verified-reference | 1.001 | 8413.0 | 14982.2 | 0.0026 | 0.0093 | — | 0.0277 | 110.2 | 0.010 | 0.013 | 0.995 | — | 0 | 16.0 |
| Regularized logistic | completed-tree | verified-optimized | 1.001 | 9495.5 | 16252.8 | 0.0030 | 0.0088 | — | 0.0227 | 792.2 | 0.009 | 0.012 | 0.996 | — | 0 | 16.0 |
| Regularized logistic | completed-tree | advancedhmc | 1.002 | 9759.9 | 17582.0 | 0.0061 | 0.0086 | — | 0.0239 | 758.3 | 0.009 | 0.012 | 0.941 | 0.996 | 0 | 16.0 |
| Regularized logistic | dynamic-nuts | verified-optimized | 1.001 | 15585.4 | 29600.1 | 0.0052 | 0.0068 | — | 0.0166 | 1384.0 | 0.007 | 0.007 | 1.000 | 0.996 | 0 | 15.0 |
| Regularized logistic | dynamic-nuts | advancedhmc | 1.001 | 15993.2 | 29018.0 | 0.0107 | 0.0068 | — | 0.0151 | 1288.7 | 0.008 | 0.008 | 1.000 | 0.996 | 0 | 15.0 |
