...
benchmark-random-sketch-dimensions:
	...
	GEOMETRY_STUDY_DRAWS=$${GEOMETRY_STUDY_DRAWS:-2000} \
	GEOMETRY_STUDY_BURNIN=$${GEOMETRY_STUDY_BURNIN:-1000} \
		julia --project=benchmark benchmark/random_sketch_geometry_study.jl
